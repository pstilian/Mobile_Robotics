...
while True:
 ...
 #       break
    ...
    gray_image = cv.cvtColor(frame, cv.COLOR_BGR2HSV)

    # convert the grayscale image to binary image
    ret,thresh = cv.threhold(gray_image,127,255,0)
    ...
    cv.putText(frame, "centroid", (cX - 25, cY - 25), cv.FONT_HERSHY_SIMPLEX, 0.5, (255, 255, 255), 2)
